...
public class EventListView extends Stage implements Observer {
    ...
    private final ListView<EventAdapter> eventListView;

    private Button createButton;

    public EventListView(Controller controller, List<EventAdapter> events) {
    ...
    private void displayEvent(EventAdapter event) {
    ...
    private void generateUserInterface() {
        ...
        createButton.setOnAction(event -> displayEvent(new EventAdapter()));
