...
public class EventRegistrationView extends Stage implements Observer {
    ...
    private final ListView<EmployeeAdapter> employeeListView;
    private final ObservableList<EmployeeAdapter> employees;

    public EventRegistrationView(Controller controller, EventAdapter event) {
        this.event = event;
        ...
        this.employees.forEach(employee -> employee.addObserver(this));
    ...
    private void displayEmployee(EmployeeAdapter employee) {
    ...
    private void generateUserInterface() {
        ...
        addEmployeeButton.setOnAction(employee -> displayEmployee(new EmployeeAdapter()));
