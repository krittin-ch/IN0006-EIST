...
1. Use AddressSanitizers to find an fix the bugs. There is also a memory leak issue which Asan might fail to detect. Also try to find it and fix it.
...
5. Do not remove or change any print statements, also make sure any changes to the Makefile are reverted when you push to test your code.
